        ...
        <aside className="w-64 bg-zinc-950 border-r border-white/5 flex flex-col justify-between h-full z-20 shrink-0 hidden md:flex">
            <div>
                ...
                <div className="h-16 flex items-center gap-3 px-6 border-b border-white/5">
                    <div className="w-9 h-9 rounded-[10px] bg-amber-500/10 border border-amber-500/25 flex items-center justify-center group-hover:bg-amber-500/20 transition-all">
                        <img src={logo} className="w-6 h-6 object-cover" />
                    </div>
                    <span id="logo-text" className="text-[15px] font-bold text-white tracking-tight" translate="no">
                        BlockWeb Master
                    </span>
                </div>
